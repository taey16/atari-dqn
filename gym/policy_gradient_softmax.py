...
while True:
  ...
  history_loss.append(dlogsoftmax[0,a])
  ...
  if done: # an episode finished
    ...
    #history_loss = np.array(history_loss, dtype=np.float64) * discounted_epr
    ...
    print '               per episode per step avg-pg: %f.' % (np.mean(history_loss))
